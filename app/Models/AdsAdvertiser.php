...
class AdsAdvertiser extends Model implements Auditable
{
    ...
    public function bids(){
        $item = Helper::callGetHTTP("https://api.adsrv.net/v2/ad/". $this->ad_api_id);

        if (!Helper::isErrorAPIAdserver($item)){
            return $item['details']['bids'];
        }

        return null;
    }

    public function numberConditions(){
        return substr_count($this->conditions, '-');
    }
