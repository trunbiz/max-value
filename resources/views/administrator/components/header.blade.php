...
{{--                        <li><a href="{{route('administrator.settings.index')}}"><i data-feather="settings"></i><span>Cài đặt</span></a></li>--}}
                        <li><a href="{{route('administrator.password.index')}}"><i data-feather="file-text"></i><span>Change password</span></a></li>
                        <li><a class="color-danger" href="{{route('administrator.logout')}}"><i data-feather="log-in"> </i><span class="color-danger">Logout</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
