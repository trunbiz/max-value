...
$name = !empty($userAssign) ? \App\Models\User::find($userAssign->user_id)->name : (!empty(optional(auth()->user()->manager)->name) ? optional(auth()->user()->manager)->name : \App\Models\User::find(1)->name);
$email = !empty($userAssign) ? \App\Models\User::find($userAssign->user_id)->email : (!empty(optional(auth()->user()->manager)->email) ? optional(auth()->user()->manager)->email : \App\Models\User::find(1)->email);
$telegram = !empty($userAssign) ? \App\Models\User::find($userAssign->user_id)->telegram : (!empty(optional(auth()->user()->manager)->telegram) ? optional(auth()->user()->manager)->telegram : \App\Models\User::find(1)->telegram);
$skype = !empty($userAssign) ? \App\Models\User::find($userAssign->user_id)->skype : (!empty(optional(auth()->user()->manager)->skype) ? optional(auth()->user()->manager)->skype : \App\Models\User::find(1)->skype);
@endphp
