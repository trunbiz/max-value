...
$name = !empty($userAssign) ? (\App\Models\User::find($userAssign->user_id)->name ?? \App\Models\User::find(1)->name) : (optional(auth()->user()->manager)->name ?? \App\Models\User::find(1)->name);
$email = !empty($userAssign) ? (\App\Models\User::find($userAssign->user_id)->email ?? \App\Models\User::find(1)->email) : (optional(auth()->user()->manager)->email ?? \App\Models\User::find(1)->email);
$telegram = !empty($userAssign) ? (\App\Models\User::find($userAssign->user_id)->telegram ?? \App\Models\User::find(1)->telegram) : (optional(auth()->user()->manager)->telegram ?? \App\Models\User::find(1)->telegram);
$skype = !empty($userAssign) ? (\App\Models\User::find($userAssign->user_id)->skype ?? \App\Models\User::find(1)->skype) : (optional(auth()->user()->manager)->skype ?? \App\Models\User::find(1)->skype);
@endphp
    ...
    <div class="row mt-3">
        <div class="col-sm-12">
            <div id="widget-referral">
                <button type="button" class="btn" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-html="true" data-bs-content-id="popover-content">
