...
<header id="header">
    <div class="header-wrapper m-0 bg-white">
        ...
        <div class="header-wrapper__toggle">
            <svg width="13" height="8" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M3.65225 6.62647L1.62728 4.50027H12.065C12.328 4.50027 12.5412 4.2764 12.5412 4.00027C12.5412 3.72413 12.328 3.50027 12.065 3.50027H1.62728L3.65225 1.37406C3.83821 1.1788 3.83821 0.862213 3.65225 0.666953C3.46628 0.471693 3.16478 0.471693 2.97882 0.666953L0.140936 3.64673C-0.0450256 3.842 -0.0450256 4.1586 0.140936 4.35387L2.97882 7.3336C3.16478 7.52887 3.46628 7.52887 3.65225 7.3336C3.83821 7.13833 3.83821 6.82173 3.65225 6.62647Z"
                    fill="#1D79C4"></path>
            </svg>
        </div>
        <div class="header-wrapper__info">
            <div class="money__info">
                <div class="notificatio__icon">
                    ...
                    <span class="total__money"
                          style="color: #ff0e1f; font-weight: 700"> $ {{Round(auth()->user()->money, 2)}}</span>
                </div>
            </div>
            <div class="notice__info">
                <div class="notificatio__icon">
                    ...
                    <span
                        class="header-nav__quantity">{{\App\Models\NotificationCustom::where('user_id', 'LIKE', '%'.auth()->id().'%')->where('viewed', 1)->count()}}</span>
                </div>
                <div class="all_notice">
                            ...
                            <div class="col-sm-12 pe-0">
                                @if(\App\Models\NotificationCustom::where('user_id', 'LIKE', '%'.auth()->id().'%')->count() > 0)
                                    @foreach(\App\Models\NotificationCustom::where('user_id', 'LIKE', '%'.auth()->id().'%')->latest()->limit(4)->get() as $itemNotification)
                                        <div
                                            class="list__news-item--content {{ (isset($itemNotification) && !empty($itemNotification) && $itemNotification->viewed == 1) ? 'active' : '' }}">
                    ...
                    @if(\App\Models\NotificationCustom::where('user_id', 'LIKE', '%'.auth()->id().'%')->count() > 0)
                        <div class="see__more text-center">
                            <a class="details-info__btn text-primary"
                               href="{{ route('user.notification_customs.index') }}">See all updates</a>
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div class="sidebar__menu bg-white">
        ...
        <ul class="sidebar__menu--main">
            <li>
                <a href="{{route('user.dashboard.index')}}"
                   class="sidebar-menu-item text-primary {{ (strpos(route('user.dashboard.index'), $_SERVER['REQUEST_URI'])) ? 'active' : '' }}">
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M10.0607 6.06068C9.47487 5.4749 9.47487 4.52515 10.0607 3.93936L12.9393 1.06068C13.5251 0.474892 14.4749 0.474891 15.0607 1.06068L17.9394 3.93936C18.5251 4.52515 18.5251 5.4749 17.9394 6.06068L15.0607 8.93937C14.4749 9.52516 13.5251 9.52516 12.9393 8.93937L10.0607 6.06068Z"
                            fill="#3FAE3B"></path>
                        <path
                            d="M2 1.00003C0.895431 1.00003 0 1.89546 0 3.00003V7.00003C0 8.1046 0.895431 9.00003 2 9.00003H6C7.10457 9.00003 8 8.1046 8 7.00003V3.00003C8 1.89546 7.10457 1.00003 6 1.00003H2Z"
                            fill="#3FAE3B"></path>
                        <path
                            d="M0 13C0 11.8955 0.895431 11 2 11H6C7.10457 11 8 11.8955 8 13V17C8 18.1046 7.10457 19 6 19H2C0.895431 19 0 18.1046 0 17V13Z"
                            fill="#3FAE3B"></path>
                        <path
                            d="M10 13C10 11.8955 10.8954 11 12 11H16C17.1046 11 18 11.8955 18 13V17C18 18.1046 17.1046 19 16 19H12C10.8954 19 10 18.1046 10 17V13Z"
                            fill="#3FAE3B"></path>
                    </svg>
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M10.0607 3.93933C9.47487 4.52512 9.47487 5.47487 10.0607 6.06065L12.9393 8.93934C13.5251 9.52513 14.4749 9.52513 15.0607 8.93934L17.9394 6.06065C18.5251 5.47487 18.5251 4.52512 17.9394 3.93933L15.0607 1.06065C14.4749 0.47486 13.5251 0.474861 12.9393 1.06065L10.0607 3.93933ZM14 2.12131L11.1213 4.99999L14 7.87868L16.8787 4.99999L14 2.12131Z"
                              fill="#47687D"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M0 3C0 1.89543 0.895431 0.999999 2 0.999999H6C7.10457 0.999999 8 1.89543 8 3V7C8 8.10457 7.10457 9 6 9H2C0.895431 9 0 8.10457 0 7V3ZM1.5 3C1.5 2.72386 1.72386 2.5 2 2.5H6C6.27614 2.5 6.5 2.72386 6.5 3V7C6.5 7.27614 6.27614 7.5 6 7.5H2C1.72386 7.5 1.5 7.27614 1.5 7V3Z"
                              fill="#47687D"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M2 11C0.895431 11 0 11.8954 0 13V17C0 18.1046 0.895431 19 2 19H6C7.10457 19 8 18.1046 8 17V13C8 11.8954 7.10457 11 6 11H2ZM6.5 13C6.5 12.7239 6.27614 12.5 6 12.5H2C1.72386 12.5 1.5 12.7239 1.5 13V17C1.5 17.2761 1.72386 17.5 2 17.5H6C6.27614 17.5 6.5 17.2761 6.5 17V13Z"
                              fill="#47687D"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M12 11C10.8954 11 10 11.8954 10 13V17C10 18.1046 10.8954 19 12 19H16C17.1046 19 18 18.1046 18 17V13C18 11.8954 17.1046 11 16 11H12ZM16.5 13C16.5 12.7239 16.2761 12.5 16 12.5H12C11.7239 12.5 11.5 12.7239 11.5 13V17C11.5 17.2761 11.7239 17.5 12 17.5H16C16.2761 17.5 16.5 17.2761 16.5 17V13Z"
                              fill="#47687D"></path>
                    </svg>
            ...
            <li>
                <a href="{{ route('user.websites.index') }}"
                   class="sidebar-menu-item text-primary {{ (request()->is('websites')) ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('user.advertises.index') }}"
                   class="sidebar-menu-item text-primary {{ (request()->is('advs')) ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li>
                <a href="{{ route('user.wallet_users.index') }}"
                   class="sidebar-menu-item text-primary {{ (request()->is('wallet')) ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li>
                <a href="{{ route('user.settings.index') }}"
                   class="sidebar-menu-item text-primary {{ (request()->is('settings')) ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li style="cursor: pointer">
                <a class="sidebar-menu-item text-primary"
    ...
    <style>
        ...
        .notificatio__icon svg {
            margin-right: 5px; /* Khoảng cách giữa svg và span */
        }
    </style>
</header>
