...
<head>
    ...
    <meta property="og:title" content="User - {{env('APP_NAME')}}" />
    ...
    <link rel="shortcut icon" type="image/png" href="{{ env('APP_URL') . \App\Models\Helper::logoImagePath() }}">
